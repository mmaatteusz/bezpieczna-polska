...
export const SOURCES = [
  ...
  {id: 'UA', name: 'UkraineAlarm — oficjalne alarmy Ukrainy', url: 'https://map.ukrainealarm.com/', enabled: true, implementation:'DORMANT_REQUIRES_EXTERNAL_API_KEY', integrationNote:'Adapter pozostaje w backendzie, ale publiczna aplikacja go nie reklamuje i domyślny worker go nie uruchamia do czasu skonfigurowania zweryfikowanego klucza API. Alarmy UA nie wpływają na status Polski.'},

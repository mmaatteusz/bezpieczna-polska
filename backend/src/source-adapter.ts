...
export const SOURCES = [
  ...
  {id: 'UA', name: 'UkraineAlarm — oficjalne alarmy Ukrainy', url: 'https://map.ukrainealarm.com/', enabled: false, implementation:'DISABLED_REQUIRES_EXTERNAL_API_KEY', integrationNote:'Integracja jest wyłączona w publicznej aplikacji do czasu skonfigurowania zweryfikowanego klucza API. Alarmy UA nie wpływają na status Polski.'},

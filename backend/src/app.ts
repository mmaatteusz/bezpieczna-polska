...
export async function buildApp(store:Store,adminToken?:string,push?:PushService){
 ...
 app.get('/healthz',async()=>({ok:true,version:'0.1.0-alpha.14'}));
